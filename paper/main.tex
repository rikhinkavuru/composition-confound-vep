...
\author{\centering \Name{Rikhin Kavuru}\\[2pt]
 \makebox[\linewidth][c]{\normalfont\itshape Independent Researcher}}
...
(TraitGym) the same models drop to roughly a fifth to a quarter, so matching removes half of
...
($-0.08$ to $-0.18$), Evo2-7B weaker ($-0.03$ to $-0.13$), and the smaller single-sequence
...
(Mendelian) and $0.520$ (complex), with recovery ratios of $0.18$--$0.25$ for the leading
